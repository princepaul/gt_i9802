...
.method private static isEmergencyNumberForCurrentIso(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v11, "isEmergencyNumberForCurrentIso: number ="
    ...
    .line 1998
    .local v4, "mccEccIso":Ljava/lang/String;
    if-nez p2, :cond_2

    const-string/jumbo v5, "ril.mcc.ecc.iso"

    .line 1999
    .local v5, "mccEccIsoProp":Ljava/lang/String;
    :goto_0
    const-string v9, ""
    ...
    invoke-static {v4, p1}, Landroid/telephony/PhoneNumberUtils;->isEmergencyIsoMatchCountryIso(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v10, "MCC/ISO is empty or matches region for ECC#\'s set via RIL db"
    ...
    .line 1998
    .end local v5    # "mccEccIsoProp":Ljava/lang/String;
    :cond_2
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v10, "ril.mcc.ecc.iso"
    ...
    .line 2007
    .restart local v5    # "mccEccIsoProp":Ljava/lang/String;
    :cond_3
    const-string v6, ""

    .line 2008
    .local v6, "mccEccList":Ljava/lang/String;
    if-nez p2, :cond_4

    const-string/jumbo v7, "ril.mcc.ecclist"

    .line 2009
    .local v7, "mccEccListProp":Ljava/lang/String;
    :goto_2
    const-string v9, ""
    ...
    .end local v2    # "i$":I
    .end local v3    # "len$":I
    .end local v7    # "mccEccListProp":Ljava/lang/String;
    :cond_4
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v10, "ril.mcc.ecclist"
    ...
    .restart local v7    # "mccEccListProp":Ljava/lang/String;
    :cond_5
    add-int/lit8 v2, v2, 0x1
...
.method private static isEmergencyNumberInternal(ILjava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p1, p2, v6}, Landroid/telephony/PhoneNumberUtils;->isEmergencyNumberForCurrentIso(Ljava/lang/String;Ljava/lang/String;I)Z
