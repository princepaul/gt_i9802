...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 150
    .local v183, "b":Landroid/os/IBinder;
    invoke-static/range {v183 .. v183}, Landroid/app/ApplicationThreadNative;->asInterface(Landroid/os/IBinder;)Landroid/app/IApplicationThread;
    ...
    .end local v15    # "profilerInfo":Landroid/app/ProfilerInfo;
    .end local v183    # "b":Landroid/os/IBinder;
    :pswitch_2
    const-string v6, "android.app.IActivityManager"
    ...
    .line 173
    .restart local v183    # "b":Landroid/os/IBinder;
    invoke-static/range {v183 .. v183}, Landroid/app/ApplicationThreadNative;->asInterface(Landroid/os/IBinder;)Landroid/app/IApplicationThread;
    ...
    .line 238
    .local v263, "result":Landroid/app/IActivityManager$WaitResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v16    # "options":Landroid/os/Bundle;
    .end local v17    # "userId":I
    .end local v263    # "result":Landroid/app/IActivityManager$WaitResult;
    :cond_7
    const/4 v15, 0x0
    ...
    .line 321
    .local v188, "callingActivity":Landroid/os/IBinder;
    sget-object v6, Landroid/content/Intent;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .end local v9    # "intent":Landroid/content/Intent;
    .end local v16    # "options":Landroid/os/Bundle;
    .end local v188    # "callingActivity":Landroid/os/IBinder;
    .end local v263    # "result":Z
    :pswitch_9
    const-string v6, "android.app.IActivityManager"
    ...
    invoke-static/range {v183 .. v183}, Landroid/content/IIntentReceiver$Stub;->asInterface(Landroid/os/IBinder;)Landroid/content/IIntentReceiver;
    ...
    .line 520
    .end local v273    # "stopProfiling":Z
    :cond_25
    const/4 v0, 0x0
    ...
    check-cast v195, Ljava/lang/CharSequence;

    .line 550
    .local v195, "description":Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    .line 556
    .end local v73    # "token":Landroid/os/IBinder;
    .end local v195    # "description":Ljava/lang/CharSequence;
    ...
    .line 584
    .restart local v260    # "res":Ljava/lang/String;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 593
    .local v190, "cn":Landroid/content/ComponentName;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 599
    .end local v73    # "token":Landroid/os/IBinder;
    .end local v190    # "cn":Landroid/content/ComponentName;
    :pswitch_20
    const-string v6, "android.app.IActivityManager"
    ...
    .line 608
    .local v278, "task":Landroid/app/IAppTask;
    invoke-interface/range {v278 .. v278}, Landroid/app/IAppTask;->asBinder()Landroid/os/IBinder;
    ...
    .end local v173    # "N":I
    .end local v208    # "i":I
    .end local v278    # "task":Landroid/app/IAppTask;
    :cond_28
    const/16 v173, -0x1
    ...
    .line 619
    .local v194, "descr":Landroid/app/ActivityManager$TaskDescription;
    ...
    .line 620
    .local v281, "thumbnail":Landroid/graphics/Bitmap;
    move-object/from16 v0, p0
    ...
    .end local v194    # "descr":Landroid/app/ActivityManager$TaskDescription;
    .end local v260    # "res":I
    .end local v281    # "thumbnail":Landroid/graphics/Bitmap;
    :pswitch_22
    const-string v6, "android.app.IActivityManager"
    ...
    .line 629
    .local v267, "size":Landroid/graphics/Point;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 635
    .end local v267    # "size":Landroid/graphics/Point;
    :pswitch_23
    const-string v6, "android.app.IActivityManager"
    ...
    check-cast v151, Landroid/app/ActivityManager$RunningTaskInfo;

    .line 645
    .local v151, "info":Landroid/app/ActivityManager$RunningTaskInfo;
    const/4 v6, 0x0
    ...
    .line 640
    .end local v151    # "info":Landroid/app/ActivityManager$RunningTaskInfo;
    .end local v173    # "N":I
    .end local v208    # "i":I
    :cond_2a
    const/16 v173, -0x1
    ...
    .line 675
    .local v280, "taskThumbnail":Landroid/app/ActivityManager$TaskThumbnail;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 686
    .end local v74    # "id":I
    .end local v280    # "taskThumbnail":Landroid/app/ActivityManager$TaskThumbnail;
    :pswitch_27
    const-string v6, "android.app.IActivityManager"
    ...
    check-cast v151, Landroid/app/ActivityManager$RunningServiceInfo;

    .line 696
    .local v151, "info":Landroid/app/ActivityManager$RunningServiceInfo;
    const/4 v6, 0x0
    ...
    .line 691
    .end local v151    # "info":Landroid/app/ActivityManager$RunningServiceInfo;
    .end local v173    # "N":I
    .end local v208    # "i":I
    :cond_2e
    const/16 v173, -0x1
    ...
    check-cast v255, Landroid/graphics/Rect;

    .line 768
    .local v255, "r":Landroid/graphics/Rect;
    move-object/from16 v0, p0
    ...
    .line 774
    .end local v255    # "r":Landroid/graphics/Rect;
    .end local v271    # "stackId":I
    :pswitch_30
    const-string v6, "android.app.IActivityManager"
    ...
    .line 785
    .local v151, "info":Landroid/app/ActivityManager$StackInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 796
    .end local v151    # "info":Landroid/app/ActivityManager$StackInfo;
    .end local v271    # "stackId":I
    :pswitch_32
    const-string v6, "android.app.IActivityManager"
    ...
    .line 847
    .local v193, "cph":Landroid/app/IActivityManager$ContentProviderHolder;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 845
    .end local v193    # "cph":Landroid/app/IActivityManager$ContentProviderHolder;
    .end local v270    # "stable":Z
    :cond_38
    const/4 v0, 0x0
    ...
    .line 852
    .restart local v193    # "cph":Landroid/app/IActivityManager$ContentProviderHolder;
    .restart local v270    # "stable":Z
    :cond_39
    const/4 v6, 0x0
    ...
    .line 879
    .local v253, "providers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/IActivityManager$ContentProviderHolder;>;"
    move-object/from16 v0, p0
    ...
    .end local v7    # "app":Landroid/app/IApplicationThread;
    .end local v183    # "b":Landroid/os/IBinder;
    .end local v253    # "providers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/IActivityManager$ContentProviderHolder;>;"
    :pswitch_3a
    const-string v6, "android.app.IActivityManager"
    ...
    .end local v183    # "b":Landroid/os/IBinder;
    .end local v260    # "res":Z
    .end local v270    # "stable":I
    .end local v283    # "unstable":I
    :pswitch_3b
    const-string v6, "android.app.IActivityManager"
    ...
    check-cast v191, Landroid/content/ComponentName;

    .line 932
    .local v191, "comp":Landroid/content/ComponentName;
    move-object/from16 v0, p0
    ...
    .line 939
    .end local v191    # "comp":Landroid/content/ComponentName;
    ...
    .line 947
    .restart local v190    # "cn":Landroid/content/ComponentName;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1002
    .restart local v17    # "userId":I
    invoke-static/range {v183 .. v183}, Landroid/app/IServiceConnection$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/IServiceConnection;
    ...
    .line 1058
    .restart local v183    # "b":Landroid/os/IBinder;
    invoke-static/range {v183 .. v183}, Landroid/app/IInstrumentationWatcher$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/IInstrumentationWatcher;
    ...
    .line 1060
    invoke-static/range {v183 .. v183}, Landroid/app/IUiAutomationConnection$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/IUiAutomationConnection;
    ...
    .line 1077
    .local v264, "results":Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .end local v53    # "resultCode":I
    .end local v183    # "b":Landroid/os/IBinder;
    .end local v264    # "results":Landroid/os/Bundle;
    :pswitch_4b
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1102
    .local v259, "requestedOrientation":I
    move-object/from16 v0, p0
    ...
    .line 1108
    .end local v73    # "token":Landroid/os/IBinder;
    .end local v259    # "requestedOrientation":I
    :pswitch_4e
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1165
    .local v255, "r":Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 1171
    .end local v255    # "r":Landroid/content/IIntentSender;
    :pswitch_53
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1174
    .restart local v255    # "r":Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 1424
    .local v268, "sourcePkg":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 1425
    .local v276, "tag":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v268    # "sourcePkg":Ljava/lang/String;
    .end local v269    # "sourceUid":I
    .end local v276    # "tag":Ljava/lang/String;
    :pswitch_6c
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1435
    .restart local v269    # "sourceUid":I
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 1436
    .restart local v276    # "tag":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1456
    .local v256, "reason":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v256    # "reason":Ljava/lang/String;
    .end local v260    # "res":Z
    .end local v265    # "secure":Z
    :pswitch_6f
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1466
    .restart local v256    # "reason":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    new-instance v189, Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    .line 1476
    .local v189, "ci":Landroid/app/ApplicationErrorReport$CrashInfo;
    move-object/from16 v0, p0
    ...
    .end local v189    # "ci":Landroid/app/ApplicationErrorReport$CrashInfo;
    :pswitch_71
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1487
    .restart local v189    # "ci":Landroid/app/ApplicationErrorReport$CrashInfo;
    move-object/from16 v0, p0
    ...
    new-instance v151, Landroid/os/StrictMode$ViolationInfo;
    ...
    .line 1498
    .local v151, "info":Landroid/os/StrictMode$ViolationInfo;
    move-object/from16 v0, p0
    ...
    .line 1504
    .end local v7    # "app":Landroid/os/IBinder;
    .end local v151    # "info":Landroid/os/StrictMode$ViolationInfo;
    ...
    .line 1538
    new-instance v151, Landroid/app/ActivityManager$RunningAppProcessInfo;

    invoke-direct/range {v151 .. v151}, Landroid/app/ActivityManager$RunningAppProcessInfo;-><init>()V

    .line 1540
    .local v151, "info":Landroid/app/ActivityManager$RunningAppProcessInfo;
    move-object/from16 v0, p0
    ...
    .line 1547
    .end local v151    # "info":Landroid/app/ActivityManager$RunningAppProcessInfo;
    :pswitch_78
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1596
    .local v185, "binder":Landroid/os/IBinder;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v10    # "resolvedType":Ljava/lang/String;
    .end local v70    # "service":Landroid/content/Intent;
    .end local v185    # "binder":Landroid/os/IBinder;
    :pswitch_7e
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1605
    .local v184, "backupRestoreMode":I
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v17    # "userId":I
    .end local v32    # "packageName":Ljava/lang/String;
    .end local v184    # "backupRestoreMode":I
    .end local v274    # "success":Z
    :pswitch_7f
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1667
    .local v252, "processName":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1674
    .end local v112    # "uid":I
    .end local v252    # "processName":Ljava/lang/String;
    :pswitch_86
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1743
    .local v186, "bundle":Landroid/os/Bundle;
    :goto_59
    if-nez v186, :cond_61
    ...
    .line 1745
    .restart local v192    # "converted":Z
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v186    # "bundle":Landroid/os/Bundle;
    .end local v192    # "converted":Z
    :cond_60
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readBundle()Landroid/os/Bundle;
    ...
    .restart local v186    # "bundle":Landroid/os/Bundle;
    goto :goto_59
    ...
    .line 1943
    .local v187, "callback":Landroid/app/IStopUserCallback;
    move-object/from16 v0, p0
    ...
    .line 1950
    .end local v187    # "callback":Landroid/app/IStopUserCallback;
    .end local v263    # "result":I
    .end local v285    # "userid":I
    :pswitch_a0
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1952
    .local v284, "userInfo":Landroid/content/pm/UserInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1958
    .end local v284    # "userInfo":Landroid/content/pm/UserInfo;
    :pswitch_a1
    const-string v6, "android.app.IActivityManager"
    ...
    .line 2130
    .local v196, "destAffinity":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 2137
    .end local v73    # "token":Landroid/os/IBinder;
    .end local v196    # "destAffinity":Ljava/lang/String;
    .end local v260    # "res":Z
    :pswitch_b4
    const-string v6, "android.app.IActivityManager"
    ...
    .line 2140
    .local v277, "target":Landroid/content/Intent;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v73    # "token":Landroid/os/IBinder;
    .end local v260    # "res":Z
    .end local v277    # "target":Landroid/content/Intent;
    :pswitch_b5
    const-string v6, "android.app.IActivityManager"
    ...
    .line 2218
    .local v257, "receiver":Lcom/android/internal/os/IResultReceiver;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;
    ...
    .end local v163    # "requestType":I
    .end local v176    # "activityToken":Landroid/os/IBinder;
    .end local v257    # "receiver":Lcom/android/internal/os/IResultReceiver;
    .end local v260    # "res":Z
    :pswitch_bd
    const-string v6, "android.app.IActivityManager"
    ...
    .line 2322
    .local v187, "callback":Landroid/app/IActivityContainerCallback;
    move-object/from16 v0, p0
    ...
    .end local v187    # "callback":Landroid/app/IActivityContainerCallback;
    ...
    .line 2361
    .restart local v197    # "displayId":I
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 2432
    .local v286, "values":Landroid/app/ActivityManager$TaskDescription;
    move-object/from16 v0, p0
    ...
    .line 2438
    .end local v73    # "token":Landroid/os/IBinder;
    .end local v286    # "values":Landroid/app/ActivityManager$TaskDescription;
    :pswitch_d4
    const-string v6, "android.app.IActivityManager"
