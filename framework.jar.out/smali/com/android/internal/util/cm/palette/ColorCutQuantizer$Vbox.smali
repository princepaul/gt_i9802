...
.method final findSplitPoint()I
    ...
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->modifySignificantOctet([IIII)V
    invoke-static {v0, v4, v6, v7}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$300([IIII)V
...
.method final fitBox()V
    ...
    .line 260
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizedRed(I)I
    invoke-static {v1}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$000(I)I

    move-result v13

    .line 261
    .local v13, "r":I
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizedGreen(I)I
    invoke-static {v1}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$100(I)I

    move-result v4

    .line 262
    .local v4, "g":I
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizedBlue(I)I
    invoke-static {v1}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$200(I)I
...
.method final getAverageColor()Lcom/android/internal/util/cm/palette/Palette$Swatch;
    ...
    .line 383
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizedRed(I)I
    invoke-static {v2}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$000(I)I
    ...
    .line 384
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizedGreen(I)I
    invoke-static {v2}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$100(I)I
    ...
    .line 385
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizedBlue(I)I
    invoke-static {v2}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$200(I)I
    ...
    # invokes: Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->approximateToRgb888(III)I
    invoke-static {v9, v5, v0}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->access$400(III)I
