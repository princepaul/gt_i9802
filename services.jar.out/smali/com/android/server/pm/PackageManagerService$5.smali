...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/io/File;IIJLandroid/os/UserHandle;ZI)V
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_file:Ljava/io/File;

    iput p3, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_parseFlags:I

    iput p4, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_scanFlags:I

    iput-wide p5, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_currentTime:J

    iput-object p7, p0, Lcom/android/server/pm/PackageManagerService$5;->val$user:Landroid/os/UserHandle;

    iput-boolean p8, p0, Lcom/android/server/pm/PackageManagerService$5;->val$isPrebundled:Z

    iput p9, p0, Lcom/android/server/pm/PackageManagerService$5;->val$prebundledUserId:I
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_file:Ljava/io/File;

    iget v2, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_parseFlags:I

    or-int/lit8 v2, v2, 0x4

    iget v3, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_scanFlags:I

    iget-wide v4, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_currentTime:J

    iget-object v6, p0, Lcom/android/server/pm/PackageManagerService$5;->val$user:Landroid/os/UserHandle;
    ...
    .line 5881
    iget-boolean v0, p0, Lcom/android/server/pm/PackageManagerService$5;->val$isPrebundled:Z
    :try_end_0
    ...
    iget v1, p0, Lcom/android/server/pm/PackageManagerService$5;->val$prebundledUserId:I
    ...
    iget-object v2, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_file:Ljava/io/File;
    ...
    .line 5906
    iget v0, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_parseFlags:I
    ...
    .line 5909
    iget-object v0, p0, Lcom/android/server/pm/PackageManagerService$5;->val$ref_file:Ljava/io/File;
