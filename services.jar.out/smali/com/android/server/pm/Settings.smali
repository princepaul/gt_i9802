...
.method createNewUserLILPw(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;I)V
    ...
    :goto_1
    invoke-virtual {v7, v8, p3}, Lcom/android/server/pm/PackageSetting;->setInstalled(ZI)V
...
.method readPackageRestrictionsLPr(I)V
    ...
    .line 1539
    .local v24, "hiddenStr":Ljava/lang/String;
    if-nez v24, :cond_10
    ...
    .end local v24    # "hiddenStr":Ljava/lang/String;
    ...
    .restart local v24    # "hiddenStr":Ljava/lang/String;
    :cond_10
    ...
    .restart local v17    # "protectedComponents":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v18    # "visibleComponents":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
...
.method shouldPrebundledPackageBeInstalledForUserLPr(Lcom/android/server/pm/PackageSetting;ILjava/lang/String;)Z
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/pm/PackageSetting;->getInstalled(I)Z
    ...
    invoke-virtual {p0, v3, p3}, Lcom/android/server/pm/Settings;->wasPrebundledPackageInstalledLPr(ILjava/lang/String;)Z
    ...
    .restart local v1    # "isInstalledForUser":Z
    :cond_2
    move v0, v3
    ...
    .restart local v0    # "isInstalledForOwner":Z
    :cond_3
    move v2, v3
...
.method writeLPr()V
    ...
    .line 2178
    const-string v19, "displayversion"
