...
.method private startOtherServices()V
    ...
    .line 436
    .local v79, "networkManagement":Lcom/android/server/NetworkManagementService;
    const/16 v83, 0x0
    ...
    .line 464
    .local v61, "externalServer":Ljava/lang/String;
    ...
    invoke-static {v10, v0, v3, v4, v5}, Lcom/android/server/wm/WindowManagerService;->main(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZ)Lcom/android/server/wm/WindowManagerService;
    ...
    .line 674
    .end local v79    # "networkManagement":Lcom/android/server/NetworkManagementService;
    ...
    invoke-direct {v3, v10}, Lcom/android/server/CertBlacklister;-><init>(Landroid/content/Context;)V
    :try_end_38
    ...
    invoke-virtual {v3, v4, v5, v8}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
    ...
    .line 1062
    .local v44, "constructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<*>;"
    const/4 v3, 0x1
    ...
    .line 1065
    .local v75, "method":Ljava/lang/reflect/Method;
    const/4 v3, 0x1
    ...
    :try_end_40
    .catch Ljava/lang/ClassNotFoundException; {:try_start_40 .. :try_end_40} :catch_2f
    .catch Ljava/lang/IllegalAccessException; {:try_start_40 .. :try_end_40} :catch_31
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_40 .. :try_end_40} :catch_32
    .catch Ljava/lang/InstantiationException; {:try_start_40 .. :try_end_40} :catch_30
    .catch Ljava/lang/NoSuchMethodException; {:try_start_40 .. :try_end_40} :catch_26

    .line 1079
    .end local v37    # "baseObject":Ljava/lang/Object;
    .end local v44    # "constructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<*>;"
    .end local v75    # "method":Ljava/lang/reflect/Method;
    ...
    .restart local v79    # "networkManagement":Lcom/android/server/NetworkManagementService;
    ...
    .line 1072
    .local v58, "e":Ljava/lang/ReflectiveOperationException;
    :goto_48
    const-string v3, "SystemServer"
    ...
    .line 1080
    .end local v58    # "e":Ljava/lang/ReflectiveOperationException;
    :catch_27
    move-exception v58
