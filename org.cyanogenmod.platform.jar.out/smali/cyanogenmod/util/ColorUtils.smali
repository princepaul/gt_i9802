...
.method public static calculateDeltaE(DDDDDD)D
    ...
    .prologue
    .line 139
    add-double v60, p0, p6

    const-wide/high16 v62, 0x4000000000000000L    # 2.0

    div-double v26, v60, v62

    .line 140
    .local v26, "Lmean":D
    mul-double v60, p2, p2

    mul-double v62, p4, p4
    ...
    .line 141
    .local v4, "C1":D
    mul-double v60, p8, p8

    mul-double v62, p10, p10
    ...
    const-wide/high16 v64, 0x401c000000000000L    # 7.0
    ...
    const-wide/high16 v66, 0x4039000000000000L    # 25.0

    const-wide/high16 v68, 0x401c000000000000L    # 7.0

    invoke-static/range {v66 .. v69}, Ljava/lang/Math;->pow(DD)D
    ...
    div-double v16, v60, v62

    .line 145
    .local v16, "G":D
    const-wide/high16 v60, 0x3ff0000000000000L    # 1.0

    add-double v60, v60, v16

    mul-double v40, p2, v60
    ...
    mul-double v42, p8, v60

    .line 148
    .local v42, "a2prime":D
    mul-double v60, v40, v40
    ...
    .line 150
    .local v10, "C2prime":D
    add-double v60, v6, v10

    const-wide/high16 v62, 0x4000000000000000L    # 2.0

    div-double v14, v60, v62
    ...
    const-wide v64, 0x401921fb54442d18L    # 6.283185307179586
    ...
    mul-double v60, v60, v64

    add-double v56, v62, v60
    ...
    add-double v58, v62, v60

    .line 156
    .local v58, "h2prime":D
    sub-double v60, v56, v58

    invoke-static/range {v60 .. v61}, Ljava/lang/Math;->abs(D)D
    ...
    add-double v60, v56, v58

    const-wide v62, 0x401921fb54442d18L    # 6.283185307179586
    ...
    const-wide v62, 0x3fc5c28f5c28f5c3L    # 0.17

    const-wide v64, 0x3fe0c152382d7365L    # 0.5235987755982988
    ...
    const-wide v62, 0x3fceb851eb851eb8L    # 0.24
    ...
    const-wide v62, 0x3fd47ae147ae147bL    # 0.32

    const-wide/high16 v64, 0x4008000000000000L    # 3.0

    mul-double v64, v64, v18

    const-wide v66, 0x3fbacee9f37bebd5L    # 0.10471975511965977
    ...
    const-wide v66, 0x3ff197c987c952c4L    # 1.0995574287564276
    ...
    sub-double v54, v58, v56

    .line 167
    .local v54, "deltahprime":D
    :goto_3
    sub-double v50, p6, p0

    .line 168
    .local v50, "deltaLprime":D
    sub-double v44, v10, v6

    .line 169
    .local v44, "deltaCprime":D
    const-wide/high16 v60, 0x4000000000000000L    # 2.0

    mul-double v62, v6, v10
    ...
    div-double v62, v54, v62

    invoke-static/range {v62 .. v63}, Ljava/lang/Math;->sin(D)D

    move-result-wide v62

    mul-double v48, v60, v62

    .line 170
    .local v48, "deltaHprime":D
    const-wide/high16 v60, 0x3ff0000000000000L    # 1.0

    const-wide v62, 0x3f8eb851eb851eb8L    # 0.015

    const-wide/high16 v64, 0x4049000000000000L    # 50.0

    sub-double v64, v26, v64
    ...
    const-wide/high16 v64, 0x4034000000000000L    # 20.0

    const-wide/high16 v66, 0x4049000000000000L    # 50.0

    sub-double v66, v26, v66

    const-wide/high16 v68, 0x4049000000000000L    # 50.0

    sub-double v68, v26, v68
    ...
    add-double v36, v60, v62

    .line 172
    .local v36, "SL":D
    const-wide/high16 v60, 0x3ff0000000000000L    # 1.0

    const-wide v62, 0x3fa70a3d70a3d70aL    # 0.045

    mul-double v62, v62, v14

    add-double v32, v60, v62
    ...
    add-double v34, v60, v62

    .line 175
    .local v34, "SH":D
    const-wide v60, 0x3fe0c152382d7365L    # 0.5235987755982988

    const-wide v62, 0x404ca5dc1a63c1f8L    # 57.29577951308232

    mul-double v62, v62, v18

    const-wide v64, 0x4071300000000000L    # 275.0

    sub-double v62, v62, v64

    const-wide/high16 v64, 0x4039000000000000L    # 25.0
    ...
    const-wide v64, 0x404ca5dc1a63c1f8L    # 57.29577951308232

    mul-double v64, v64, v18

    const-wide v66, 0x4071300000000000L    # 275.0
    ...
    invoke-static/range {v62 .. v63}, Ljava/lang/Math;->exp(D)D
    ...
    div-double v60, v50, v60

    mul-double v62, v24, v36

    div-double v62, v50, v62

    mul-double v60, v60, v62

    mul-double v62, v20, v32

    div-double v62, v44, v62

    mul-double v64, v20, v32

    div-double v64, v44, v64

    mul-double v62, v62, v64

    add-double v60, v60, v62

    mul-double v62, v22, v34

    div-double v62, v48, v62

    mul-double v64, v22, v34

    div-double v64, v48, v64
    ...
    .end local v36    # "SL":D
    .end local v38    # "T":D
    .end local v44    # "deltaCprime":D
    .end local v46    # "deltaE":D
    .end local v48    # "deltaHprime":D
    .end local v50    # "deltaLprime":D
    .end local v52    # "deltaTheta":D
    .end local v54    # "deltahprime":D
    .end local v56    # "h1prime":D
    .end local v58    # "h2prime":D
    :cond_0
    const/16 v60, 0x0
    ...
    .restart local v38    # "T":D
    :cond_3
    cmpg-double v60, v58, v56

    if-gtz v60, :cond_4

    sub-double v60, v58, v56

    const-wide v62, 0x401921fb54442d18L    # 6.283185307179586

    add-double v54, v60, v62
...
.method public static convertRGBtoLAB(I)[F
    ...
    .line 115
    .local v2, "Ls":F
    const/high16 v23, 0x43fa0000    # 500.0f
    ...
    const-wide v26, 0x3fac28f5c28f5c29L    # 0.055

    add-double v24, v24, v26

    const-wide v26, 0x3ff0e147ae147ae1L    # 1.055

    div-double v24, v24, v26

    const-wide v26, 0x4003333333333333L    # 2.4
...
.method public static generateAlertColorFromDrawable(Landroid/graphics/drawable/Drawable;)I
    ...
    .line 308
    .end local v0    # "alertColor":I
    .local v1, "alertColor":I
    :goto_0
    return v1

    .line 271
    .end local v1    # "alertColor":I
    .restart local v0    # "alertColor":I
    :cond_0
    ...
    .line 284
    invoke-static {v2}, Lcom/android/internal/util/cm/palette/Palette;->from(Landroid/graphics/Bitmap;)Lcom/android/internal/util/cm/palette/Palette$Builder;

    move-result-object v9

    invoke-virtual {v9}, Lcom/android/internal/util/cm/palette/Palette$Builder;->generate()Lcom/android/internal/util/cm/palette/Palette;

    move-result-object v7

    .line 285
    .local v7, "p":Lcom/android/internal/util/cm/palette/Palette;
    if-nez v7, :cond_2
    ...
    .line 286
    .end local v0    # "alertColor":I
    .restart local v1    # "alertColor":I
    goto :goto_0

    .line 274
    .end local v1    # "alertColor":I
    .end local v7    # "p":Lcom/android/internal/util/cm/palette/Palette;
    .restart local v0    # "alertColor":I
    :cond_1
    ...
    .restart local v7    # "p":Lcom/android/internal/util/cm/palette/Palette;
    :cond_2
    invoke-static {v7}, Lcyanogenmod/util/ColorUtils;->getDominantSwatch(Lcom/android/internal/util/cm/palette/Palette;)Lcom/android/internal/util/cm/palette/Palette$Swatch;

    move-result-object v4

    .line 291
    .local v4, "dominantSwatch":Lcom/android/internal/util/cm/palette/Palette$Swatch;
    move v6, v0
    ...
    .line 293
    invoke-virtual {v4}, Lcom/android/internal/util/cm/palette/Palette$Swatch;->getRgb()I

    move-result v6

    .line 294
    invoke-static {v6}, Lcyanogenmod/util/ColorUtils;->findPerceptuallyNearestSolidColor(I)I
    ...
    .line 299
    :cond_4
    invoke-virtual {v7, v12}, Lcom/android/internal/util/cm/palette/Palette;->getVibrantColor(I)I
    ...
    .end local v4    # "dominantSwatch":Lcom/android/internal/util/cm/palette/Palette$Swatch;
...
.method public static temperatureToRGB(I)[F
    ...
    invoke-static {v5, v0}, Lcyanogenmod/util/ColorUtils;->interp(IF)F
