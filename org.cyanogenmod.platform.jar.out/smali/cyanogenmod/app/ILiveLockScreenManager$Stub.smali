...
.method public static asInterface(Landroid/os/IBinder;)Lcyanogenmod/app/ILiveLockScreenManager;
    ...
    .line 102
    :cond_1
    new-instance v0, Lcyanogenmod/app/ILiveLockScreenManager$Stub$Proxy;

    .end local v0    # "iin":Landroid/os/IInterface;
    invoke-direct {v0, p0}, Lcyanogenmod/app/ILiveLockScreenManager$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .restart local v3    # "_arg2":Lcyanogenmod/app/LiveLockScreenInfo;
    goto :goto_1
    ...
    .line 149
    .local v3, "_arg2":I
    invoke-virtual {p0, v1, v2, v3}, Lcyanogenmod/app/ILiveLockScreenManager$Stub;->cancelLiveLockScreen(Ljava/lang/String;II)V
    ...
    :sswitch_3
    const-string v8, "cyanogenmod.app.ILiveLockScreenManager"
    ...
    .line 157
    .local v6, "_result":Lcyanogenmod/app/LiveLockScreenInfo;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 160
    invoke-virtual {v6, p3, v7}, Lcyanogenmod/app/LiveLockScreenInfo;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 169
    .end local v6    # "_result":Lcyanogenmod/app/LiveLockScreenInfo;
    :sswitch_4
    const-string v8, "cyanogenmod.app.ILiveLockScreenManager"
    ...
    .line 171
    .restart local v6    # "_result":Lcyanogenmod/app/LiveLockScreenInfo;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    check-cast v1, Lcyanogenmod/app/LiveLockScreenInfo;

    .line 191
    .local v1, "_arg0":Lcyanogenmod/app/LiveLockScreenInfo;
    :goto_2
    invoke-virtual {p0, v1}, Lcyanogenmod/app/ILiveLockScreenManager$Stub;->setDefaultLiveLockScreen(Lcyanogenmod/app/LiveLockScreenInfo;)V
    ...
    .line 189
    .end local v1    # "_arg0":Lcyanogenmod/app/LiveLockScreenInfo;
    :cond_3
    const/4 v1, 0x0

    .restart local v1    # "_arg0":Lcyanogenmod/app/LiveLockScreenInfo;
    goto :goto_2
    ...
    .local v1, "_arg0":Z
    :goto_3
    invoke-virtual {p0, v1}, Lcyanogenmod/app/ILiveLockScreenManager$Stub;->setLiveLockScreenEnabled(Z)V
    ...
    invoke-static {v8}, Lcyanogenmod/app/ILiveLockScreenChangeListener$Stub;->asInterface(Landroid/os/IBinder;)Lcyanogenmod/app/ILiveLockScreenChangeListener;

    move-result-object v1

    .line 216
    .local v1, "_arg0":Lcyanogenmod/app/ILiveLockScreenChangeListener;
    invoke-virtual {p0, v1}, Lcyanogenmod/app/ILiveLockScreenManager$Stub;->registerChangeListener(Lcyanogenmod/app/ILiveLockScreenChangeListener;)Z
    ...
    .line 223
    .end local v1    # "_arg0":Lcyanogenmod/app/ILiveLockScreenChangeListener;
    .end local v6    # "_result":Z
    :sswitch_9
    const-string v8, "cyanogenmod.app.ILiveLockScreenManager"
    ...
    .line 226
    .restart local v1    # "_arg0":Lcyanogenmod/app/ILiveLockScreenChangeListener;
    invoke-virtual {p0, v1}, Lcyanogenmod/app/ILiveLockScreenManager$Stub;->unregisterChangeListener(Lcyanogenmod/app/ILiveLockScreenChangeListener;)Z
