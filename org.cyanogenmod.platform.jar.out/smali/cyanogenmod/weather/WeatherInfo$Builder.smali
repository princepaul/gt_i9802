...
.method public build()Lcyanogenmod/weather/WeatherInfo;
    ...
    invoke-direct {v0, v1}, Lcyanogenmod/weather/WeatherInfo;-><init>(Lcyanogenmod/weather/WeatherInfo$1;)V
    ...
    # setter for: Lcyanogenmod/weather/WeatherInfo;->mCity:Ljava/lang/String;
    invoke-static {v0, v1}, Lcyanogenmod/weather/WeatherInfo;->access$202(Lcyanogenmod/weather/WeatherInfo;Ljava/lang/String;)Ljava/lang/String;

    .line 217
    iget v1, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mConditionCode:I

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mConditionCode:I
    invoke-static {v0, v1}, Lcyanogenmod/weather/WeatherInfo;->access$302(Lcyanogenmod/weather/WeatherInfo;I)I

    .line 218
    iget-wide v2, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mTemperature:D

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mTemperature:D
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$402(Lcyanogenmod/weather/WeatherInfo;D)D

    .line 219
    iget v1, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mTempUnit:I

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mTempUnit:I
    invoke-static {v0, v1}, Lcyanogenmod/weather/WeatherInfo;->access$502(Lcyanogenmod/weather/WeatherInfo;I)I

    .line 220
    iget-wide v2, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mHumidity:D

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mHumidity:D
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$602(Lcyanogenmod/weather/WeatherInfo;D)D

    .line 221
    iget-wide v2, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mWindSpeed:D

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mWindSpeed:D
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$702(Lcyanogenmod/weather/WeatherInfo;D)D

    .line 222
    iget-wide v2, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mWindDirection:D

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mWindDirection:D
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$802(Lcyanogenmod/weather/WeatherInfo;D)D

    .line 223
    iget v1, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mWindSpeedUnit:I

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mWindSpeedUnit:I
    invoke-static {v0, v1}, Lcyanogenmod/weather/WeatherInfo;->access$902(Lcyanogenmod/weather/WeatherInfo;I)I
    ...
    :goto_0
    # setter for: Lcyanogenmod/weather/WeatherInfo;->mTimestamp:J
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$1002(Lcyanogenmod/weather/WeatherInfo;J)J

    .line 225
    iget-object v1, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mForecastList:Ljava/util/List;

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mForecastList:Ljava/util/List;
    invoke-static {v0, v1}, Lcyanogenmod/weather/WeatherInfo;->access$1102(Lcyanogenmod/weather/WeatherInfo;Ljava/util/List;)Ljava/util/List;

    .line 226
    iget-wide v2, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mTodaysHighTemp:D

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mTodaysHighTemp:D
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$1202(Lcyanogenmod/weather/WeatherInfo;D)D

    .line 227
    iget-wide v2, p0, Lcyanogenmod/weather/WeatherInfo$Builder;->mTodaysLowTemp:D

    # setter for: Lcyanogenmod/weather/WeatherInfo;->mTodaysLowTemp:D
    invoke-static {v0, v2, v3}, Lcyanogenmod/weather/WeatherInfo;->access$1302(Lcyanogenmod/weather/WeatherInfo;D)D
    ...
    # setter for: Lcyanogenmod/weather/WeatherInfo;->mKey:Ljava/lang/String;
    invoke-static {v0, v1}, Lcyanogenmod/weather/WeatherInfo;->access$1402(Lcyanogenmod/weather/WeatherInfo;Ljava/lang/String;)Ljava/lang/String;
...
.method public setWeatherCondition(I)Lcyanogenmod/weather/WeatherInfo$Builder;
    ...
    .prologue
    .line 163
    # invokes: Lcyanogenmod/weather/WeatherInfo;->isValidWeatherCode(I)Z
    invoke-static {p1}, Lcyanogenmod/weather/WeatherInfo;->access$000(I)Z
