...
.method public build()Lcyanogenmod/weather/RequestInfo;
    ...
    invoke-direct {v0, v1}, Lcyanogenmod/weather/RequestInfo;-><init>(Lcyanogenmod/weather/RequestInfo$1;)V
    ...
    # setter for: Lcyanogenmod/weather/RequestInfo;->mListener:Lcyanogenmod/weather/IRequestInfoListener;
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$102(Lcyanogenmod/weather/RequestInfo;Lcyanogenmod/weather/IRequestInfoListener;)Lcyanogenmod/weather/IRequestInfoListener;

    .line 168
    iget v1, p0, Lcyanogenmod/weather/RequestInfo$Builder;->mRequestType:I

    # setter for: Lcyanogenmod/weather/RequestInfo;->mRequestType:I
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$202(Lcyanogenmod/weather/RequestInfo;I)I

    .line 169
    iget-object v1, p0, Lcyanogenmod/weather/RequestInfo$Builder;->mCityName:Ljava/lang/String;

    # setter for: Lcyanogenmod/weather/RequestInfo;->mCityName:Ljava/lang/String;
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$302(Lcyanogenmod/weather/RequestInfo;Ljava/lang/String;)Ljava/lang/String;

    .line 170
    iget-object v1, p0, Lcyanogenmod/weather/RequestInfo$Builder;->mWeatherLocation:Lcyanogenmod/weather/WeatherLocation;

    # setter for: Lcyanogenmod/weather/RequestInfo;->mWeatherLocation:Lcyanogenmod/weather/WeatherLocation;
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$402(Lcyanogenmod/weather/RequestInfo;Lcyanogenmod/weather/WeatherLocation;)Lcyanogenmod/weather/WeatherLocation;

    .line 171
    iget-object v1, p0, Lcyanogenmod/weather/RequestInfo$Builder;->mLocation:Landroid/location/Location;

    # setter for: Lcyanogenmod/weather/RequestInfo;->mLocation:Landroid/location/Location;
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$502(Lcyanogenmod/weather/RequestInfo;Landroid/location/Location;)Landroid/location/Location;

    .line 172
    iget v1, p0, Lcyanogenmod/weather/RequestInfo$Builder;->mTempUnit:I

    # setter for: Lcyanogenmod/weather/RequestInfo;->mTempUnit:I
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$602(Lcyanogenmod/weather/RequestInfo;I)I

    .line 173
    iget-boolean v1, p0, Lcyanogenmod/weather/RequestInfo$Builder;->mIsQueryOnly:Z

    # setter for: Lcyanogenmod/weather/RequestInfo;->mIsQueryOnly:Z
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$702(Lcyanogenmod/weather/RequestInfo;Z)Z
    ...
    # setter for: Lcyanogenmod/weather/RequestInfo;->mKey:Ljava/lang/String;
    invoke-static {v0, v1}, Lcyanogenmod/weather/RequestInfo;->access$802(Lcyanogenmod/weather/RequestInfo;Ljava/lang/String;)Ljava/lang/String;
