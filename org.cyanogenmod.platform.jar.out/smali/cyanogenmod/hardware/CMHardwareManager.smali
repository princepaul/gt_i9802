...
.method public getColorBalance()I
    ...
    invoke-interface {v0}, Lcyanogenmod/hardware/ICMHardwareService;->getColorBalance()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getColorBalanceRange()Landroid/util/Range;
    ...
    invoke-interface {v2}, Lcyanogenmod/hardware/ICMHardwareService;->getColorBalanceMin()I
    ...
    invoke-interface {v2}, Lcyanogenmod/hardware/ICMHardwareService;->getColorBalanceMax()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getDefaultPictureAdjustment()Lcyanogenmod/hardware/HSIC;
    ...
    invoke-interface {v0}, Lcyanogenmod/hardware/ICMHardwareService;->getDefaultPictureAdjustment()Lcyanogenmod/hardware/HSIC;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getPictureAdjustment()Lcyanogenmod/hardware/HSIC;
    ...
    invoke-interface {v0}, Lcyanogenmod/hardware/ICMHardwareService;->getPictureAdjustment()Lcyanogenmod/hardware/HSIC;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getPictureAdjustmentRanges()Ljava/util/List;
    ...
    invoke-interface {v1}, Lcyanogenmod/hardware/ICMHardwareService;->getPictureAdjustmentRanges()[F
    ...
    .line 932
    .end local v0    # "ranges":[F
    :goto_1
    return-object v1

    .line 921
    .restart local v0    # "ranges":[F
    :cond_0
    new-instance v1, Landroid/util/Range;
...
.method public setColorBalance(I)Z
    ...
    invoke-interface {v0, p1}, Lcyanogenmod/hardware/ICMHardwareService;->setColorBalance(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setPictureAdjustment(Lcyanogenmod/hardware/HSIC;)Z
    ...
    invoke-interface {v0, p1}, Lcyanogenmod/hardware/ICMHardwareService;->setPictureAdjustment(Lcyanogenmod/hardware/HSIC;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
